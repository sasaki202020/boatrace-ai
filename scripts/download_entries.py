"""
番組表 (B*.LZH) ダウンロードスクリプト

使い方:
  py scripts/download_entries.py --start 20240101 --end 20241231
  py scripts/download_entries.py --start 20240101 --end 20241231 --dry-run
"""
import argparse
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description="番組表 (B*.LZH) ダウンロード")
    ...
    logger.info("=== Entries Download Summary ===")
