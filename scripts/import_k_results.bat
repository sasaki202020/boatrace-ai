...
set "LOG_FILE=logs\tasks\import_k_results_!RUN_DATE!_!RUN_TIME!.log"
echo [START] import_k_results !RUN_DATE! !RUN_TIME!
echo [START] import_k_results !RUN_DATE! !RUN_TIME!>>"!LOG_FILE!"
echo [CMD] !PYTHON_EXE! -m src.pipeline.import_k_results --input-dir data/inbox/k_results --target-dir data/raw/official/results
...
echo [END] import_k_results exit=!EXIT_CODE!
echo [END] import_k_results exit=!EXIT_CODE!>>"!LOG_FILE!"
popd
exit /b !EXIT_CODE!
