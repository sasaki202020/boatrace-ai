...
set "LOG_FILE=logs\tasks\prediction_review_!RUN_DATE!_!RUN_TIME!.log"
echo [START] prediction_review !RUN_DATE! !RUN_TIME!
echo [START] prediction_review !RUN_DATE! !RUN_TIME!>>"!LOG_FILE!"
echo [CMD] !PYTHON_EXE! scripts\build_prediction_review.py --date !RUN_DATE_ISO!
!PYTHON_EXE! scripts\build_prediction_review.py --date !RUN_DATE_ISO!>>"!LOG_FILE!" 2>&1
set "EXIT_CODE=!ERRORLEVEL!"
echo [EXIT] !EXIT_CODE!>>"!LOG_FILE!"
echo [END] prediction_review exit=!EXIT_CODE!
echo [END] prediction_review exit=!EXIT_CODE!>>"!LOG_FILE!"
popd
exit /b !EXIT_CODE!
